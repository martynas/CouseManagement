...
<asp:Content ContentPlaceHolderID="Content" runat="server">
    ...
    <p>
        <table class="editlist">
            <tr>
                <th>Title:</th>
                <td><asp:TextBox runat="server" ID="tbTitle" Text='<%# EditedContact.Title %>' CssClass="text normal" /></td>
            </tr>
            <tr>
                <th>First name:</th>
                <td><asp:TextBox runat="server" ID="tbFirstName" Text='<%# Bind("EditedContact.FirstName") %>' CssClass="text normal" /></td>
            </tr>
            <tr>
                <th>Last name:</th>
                <td><asp:TextBox runat="server" ID="tbLastName" Text="<%# EditedContact.LastName %>" CssClass="text normal" /></td>
            </tr>
            <tr>
                <th>Email:</th>
                <td><asp:TextBox runat="server" ID="tbEmail" Text="<%# EditedContact.Email %>" CssClass="text normal" /></td>
            </tr>
            <tr>
                <th>Mobile phone:</th>
                <td><asp:TextBox runat="server" ID="tbMobilePhone" Text="<%# EditedContact.MobilePhone %>" CssClass="text normal" /></td>
            </tr>
        </table>
    </p>
