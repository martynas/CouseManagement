<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TrainingActivityHeading.ascx.cs" Inherits="Atrendia.CourseManagement.Frontend.Support.Controls.TrainingActivityHeading" %>
